...
<nav class="navbar navbar-expand-md navbar-dark bg-dark mb-4">
  <a class="navbar-brand" href="http://localhost:8080/spring_security_conference_war">Get Started</a>
  <a class="navbar-brand" href="<c:out value='perform_logout'/>">Logout</a>
</nav>

<main role="main" class="container">
  <div class="jumbotron">
    <h1>Welcome to the Spring Security App!</h1>
    ...
    <a class="btn btn-lg btn-primary" href="account" role="button">
      Create Account
    </a>
  </div>
</main>
